...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'registration.check_email' => '<p>We are still receiving entries from other Digit enthusiasts like you.</p> Expect us to contact you shortly, once the deadline closes and we have thoroughly screened all the entries.

We are super excited about the e-version initiative of our beloved Digit magazine – JUST LIKE YOU! And hence look forward to your valuable, honest, detailed feedback about the same.

Keep showering your love on us and stay tuned for our invite!!!
',
    'registration.confirmed' => 'Congrats %username%, your account is now activated',
    'registration.back' => 'Back to the originating page.',
    'registration.submit' => 'Register',
    'registration.flash.user_created' => 'The user has been created successfully',
    'registration.email.subject' => 'Digit e-mag pre-beta launch invite – entry received',
    'registration.email.message' => 'Hello %username%!

THANKS FOR YOUR INTEREST
We are still receiving entries from other Digit enthusiasts like you. Expect us to contact you shortly, once the deadline closes and we have thoroughly screened all the entries. 
We are super excited about the e-version initiative of our beloved Digit magazine – JUST LIKE YOU! And hence look forward to your valuable, honest, detailed feedback about the same. 
Keep showering your love on us and stay tuned for our invite!!!
...
',
    ...
    'resetting.request.invalid_username' => 'The email address "%username%" does not exist.',
