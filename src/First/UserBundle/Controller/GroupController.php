...
class GroupController extends Controller
{
    ...
    public function listAction()
    {
        ...
        return $this->render('FirstUserBundle:Group:list.html.twig', array(
            'groups' => $groups
        ));
    }
    ...
    public function showAction($groupName)
    {
        ...
        return $this->render('FirstUserBundle:Group:show.html.twig', array(
            'group' => $group
        ));
    }
    ...
    public function editAction(Request $request, $groupName)
    {
        ...
        if ($form->isValid()) {
            ...
            if (null === $response = $event->getResponse()) {
                $url = $this->generateUrl('first_user_group_show', array('groupName' => $group->getName()));
        ...
        return $this->render('FirstUserBundle:Group:edit.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('FirstUserBundle:Group:new.html.twig', array(
            'form' => $form->createview(),
        ));
    }
    ...
    public function deleteAction(Request $request, $groupName)
    {
        ...
        $response = new RedirectResponse($this->generateUrl('first_user_group_list'));
