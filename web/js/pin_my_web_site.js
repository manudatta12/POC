...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'Thinkdigit', // Site Name
		applicationName: 'Thinkdigit', // Site Name 
		startURL: 'http://www.thinkdigit.com/', // Homepage URL 
		shortcutIcon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Main-favicon.ico', // Main Site Icon
		tooltip: '',

		// Dynamic jumplist tasks & notifications
		rssFeedURL: 'http://www.pinmywebsite.com/RSSFeed?feed=http%3a%2f%2ffeeds.feedburner.com%2fthinkdigit%2fzpZl',
		categoryTitle: 'Digit Tech News', // Task group name
		defaultTaskIcon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/GenericTask-favicon.ico', // Generic task icon
		...
		staticTasks: [{ name: 'Technology News',  action: 'http://www.thinkdigit.com/technology-news.html', icon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Task3-favicon.ico', target: 'tab' },{ name: 'Technology Reviews',  action: 'http://www.thinkdigit.com/review.php', icon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Task4-favicon.ico', target: 'tab' },{ name: 'Download Software',  action: 'http://www.thinkdigit.com/download.php', icon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Task1-favicon.ico', target: 'tab' },{ name: 'Digit Technology Forum',  action: 'http://www.thinkdigit.com/forum/', icon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Task2-favicon.ico', target: 'tab' },{ name: 'Technology Videos',  action: 'http://www.thinkdigit.com/videos.php', icon: 'https://ie9pinning.blob.core.windows.net/files/JumpList/634528893209370414/Task0-favicon.ico', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'Thinkdigit' // Site name as it should appear on the pinning bar
	};
